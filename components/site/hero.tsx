...
/** Circular badge with a rotating caption ring — the "Play Showreel" affordance. */
function ShowreelBadge() {
  const label = 'PLAY SHOWREEL — PLAY SHOWREEL — ';
  return (
    <motion.button
...
export function Hero() {
  ...
  return (
    <section ref={ref} id="top" className="relative flex min-h-svh flex-col justify-between pt-28 lg:pt-32">
      <motion.div style={{ y, opacity }} className="edge">
        {/* Off-screen twin at a fixed size — gives us the glyph run width to solve against. */}
        <span
          ref={measureRef}
          aria-hidden
        ...
        >
          ...
          <MaskChars text={site.wordmark} delay={0.25} className="justify-center" />
        </h1>
      </motion.div>
      ...
      <div className="edge flex items-end justify-between gap-8 pb-10 lg:pb-16">
        ...
        <div className="flex items-center gap-8">
          ...
          <motion.div
            ...
            className="hidden text-2xl lg:block"
          >
            &darr;
          </motion.div>
        </div>
